...
// ✅ Menggunakan action khusus Radir yang sudah kita buat sebelumnya
...
// ✅ Didefinisikan di luar agar referensi stabil untuk useEffect/useMemo
...
export function EditRadirModal({ agenda, open, onOpenChange }: EditRadirModalProps) {
    ...
    // ✅ Logika "Dapat Dilanjutkan" (isComplete) - Ditambahkan FILE_FIELDS ke dependensi
                ...
                toast.custom((t) => (
                    <div className="flex items-center gap-4 bg-white border-l-4 border-[#14a2ba] p-4 shadow-2xl rounded-lg">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-[10px] text-slate-500 uppercase tracking-widest">Data usulan radir telah diperbarui</p>
                        </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                            ...
                                                            <AlertDialogContent className="border-none shadow-2xl">
                                                                <AlertDialogHeader>
                                                                    <AlertDialogTitle className="text-[#125d72] font-black uppercase text-sm flex items-center gap-2">
                                                                        <AlertCircle className="h-5 w-5 text-red-500" /> Hapus Berkas?
                                                                    </AlertDialogTitle>
                                                                    <AlertDialogDescription className="text-xs italic">Apakah Anda yakin? File akan dihapus secara permanen dari sistem saat Anda menyimpan perubahan ini.</AlertDialogDescription>
                                                                </AlertDialogHeader>
                                                                <AlertDialogFooter>
                                    ...
                                    <div className={`p-4 rounded-xl border-2 transition-all col-span-1 md:col-span-2 ${notRequired.includes('supportingDocuments') ? 'bg-slate-50 border-slate-200 opacity-60' : 'border-dashed border-slate-300 bg-slate-50'}`}>
                                        <div className="flex justify-between items-center mb-3">
                                            <Label className="text-[10px] font-black text-[#125d72] uppercase">Dokumen Pendukung Lainnya (Multi-File)</Label>
