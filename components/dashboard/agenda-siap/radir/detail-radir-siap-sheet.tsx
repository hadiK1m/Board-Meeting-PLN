...
export function DetailAgendaSheet({ agenda, open, onOpenChange }: DetailAgendaSheetProps) {
    ...
    return (
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent
                side="right"
                // ✅ Fix Scroll 1: Menggunakan h-dvh dan flex-col agar pas di viewport
            ...
            >
                ...
                {/* ✅ Fix Scroll 2: Gunakan min-h-0 dan flex-1 agar area scroll mengambil sisa ruang dengan benar */}
                <ScrollArea className="flex-1 min-h-0 bg-slate-50 border-t">
                    ...
                    <div className="p-6 md:p-8 space-y-6 md:space-y-8 pb-40">
                        ...
                        {/* SECTION 1: URGENSI, DEADLINE, PRIORITAS */}
                        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                            {/* Urgensi dibuat Full Width agar teks panjang muat */}
                        ...
                        {/* Extra spacer untuk memastikan konten paling bawah tidak tertutup sheet footer/browser UI */}
